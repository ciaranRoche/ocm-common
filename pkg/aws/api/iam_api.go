...
//go:generate mockgen -source=iam_api.go -package=api -destination=./iam_api_mock.go
type IamApiClient interface {
	...
	ListInstanceProfileTags(ctx context.Context, params *iam.ListInstanceProfileTagsInput, optFns ...func(*iam.Options),
	) (*iam.ListInstanceProfileTagsOutput, error)
