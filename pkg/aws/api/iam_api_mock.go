...
//
//	mockgen -source=iam_api.go -package=api -destination=./iam_api_mock.go
//
...
func (m *MockIamApiClient) ListInstanceProfileTags(ctx context.Context, params *iam.ListInstanceProfileTagsInput, optFns ...func(*iam.Options)) (*iam.ListInstanceProfileTagsOutput, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, params}
	for _, a := range optFns {
		varargs = append(varargs, a)
...
func (mr *MockIamApiClientMockRecorder) ListInstanceProfileTags(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListInstanceProfileTags", reflect.TypeOf((*MockIamApiClient)(nil).ListInstanceProfileTags), varargs...)
}
